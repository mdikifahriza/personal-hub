...
interface Transaction {
  ...
  date: string;
  source_type?: 'task_payment' | 'recurring' | 'manual' | null;
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {getAccountName(trans.account_id)} | {format(new Date(trans.date), 'dd MMM yyyy')}
                  </p>

                  {(trans.source_type === 'task_payment' || trans.is_auto_generated) && (
                    <p className="text-xs text-blue-700 mt-1">Auto dari pembayaran task</p>
                  )}
